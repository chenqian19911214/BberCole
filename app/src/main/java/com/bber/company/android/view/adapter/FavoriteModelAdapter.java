 ...
 */
public class FavoriteModelAdapter extends RecyclerView.Adapter<FavoriteModelAdapter.ViewHolder> implements View.OnClickListener, View.OnLongClickListener {
    private static OnRecyclerViewItemLongClickListener mOnItemLongClickListener = null;
    ...
    public FavoriteModelAdapter(Activity activity, List<SellerUserVo> sellerUserVo) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_favorite_model, viewGroup, false);
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, int position) {
        ...
        viewHolder.favorirte.setTag(seller);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            favorirte = itemView.findViewById(R.id.btn_favorite);
            favorirte.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (mOnItemLongClickListener != null) {
                        //注意这里使用getTag方法获取数据
                        mOnItemLongClickListener.onItemLongClick(v, (SellerUserVo) v.getTag());
                    }
                }
            });
        }
