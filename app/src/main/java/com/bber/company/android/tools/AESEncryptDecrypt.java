...
public class AESEncryptDecrypt {
    ...
    private static final String key0 = "whatisahahafuckingday";
    private static final Charset charset = Charset.forName("UTF-8");
    //注意: 这里的password(秘钥必须是16位的)
    private static final String keyBytes = "abcdefghijklqweq";
    static boolean isInited = false;
    static private KeyGenerator keyGen;
    static private Cipher cipher;
    private static byte[] keyBytesByUs = key0.getBytes(charset);
    ...
    public static String encodeByUs(String enc) {
        byte[] b = enc.getBytes(charset);
        for (int i = 0, size = b.length; i < size; i++) {
            for (byte keyBytes0 : keyBytesByUs) {
    ...
    public static String decodeByUs(String dec) {
