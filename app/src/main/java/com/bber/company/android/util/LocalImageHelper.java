...
/**
 * Created by carlo.c on 2018/4/15.
 */
...
public class LocalImageHelper {
    ...
    public static LocalImageHelper getInstance(MyApplication context) {
        if (instance == null) {
    ...
    public static LocalImageHelper init(MyApplication context) {
        instance = new LocalImageHelper(context);
...
//        }).start();
    ...
    public String setCameraImgPath() {
        String foloder = MyApplication.getContext().getCachePath()
                + "/PostPicture/";
