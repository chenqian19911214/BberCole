...
public class GestureDrawline extends View {
    ...
    public GestureDrawline(Context context, List<GesturePoint> list, boolean isVerify,
        ...
        paint.setColor(Color.rgb(255, 0, 102));// 设置默认连线颜色
        ...
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (currentPoint != null) {
                    currentPoint.setPointState(PointState.SELECTED);
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (pointAt == null || currentPoint.equals(pointAt) || PointState.SELECTED == pointAt.getPointState()) {
                    ...
                    pointAt.setPointState(PointState.SELECTED);
    ...
    private void drawErrorPathTip() {
        canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
        paint.setColor(Color.rgb(255, 0, 0));// 设置默认线路颜色
        for (Pair<GesturePoint, GesturePoint> pair : lineList) {
    ...
    final class clearStateRunnable implements Runnable {
        public void run() {
            ...
            for (GesturePoint p : list) {
                p.setPointState(PointState.NORMAL);
            }
            invalidate();
            isDrawEnable = true;
        }
