...
import com.bber.company.android.entity.GesturePoint;
...
public class GestureContentView extends ViewGroup {
     ...
     * @param gestureCallBack 手势绘制完毕的回调
     */
    public GestureContentView(Context context, boolean isVerify, String passWord, GestureDrawline.GestureCallBack gestureCallBack) {
        super(context);
        screenDispaly = Tools.getScreenDispaly(context);
        blockWidth = (screenDispaly[0] * 8 / 10) / 3;
        ...
        addChild();
        // 初始化一个可以画线的view
        gestureDrawline = new GestureDrawline(context, list, isVerify, passWord, gestureCallBack);
    }
    ...
    public void setParentView(ViewGroup parent) {
        // 得到屏幕的宽度
        int width = (screenDispaly[0] * 8 / 10);
