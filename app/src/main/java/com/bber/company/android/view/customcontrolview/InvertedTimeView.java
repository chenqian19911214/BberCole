 ...
 * 倒计时 器
 */
public class InvertedTimeView extends TextView {
    ...
    public InvertedTimeView(Context context) {
        this(context, null);
    }

    public InvertedTimeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void getTime() {
        try {
            ...
            setText(setTextDian(hours) + ":" + setTextDian(minutes) + ":" + setTextDian(seconds));
    ...
    private String setTextDian(long textDian) {
        DecimalFormat df = new DecimalFormat("00");
        return df.format(textDian);
    }
}
