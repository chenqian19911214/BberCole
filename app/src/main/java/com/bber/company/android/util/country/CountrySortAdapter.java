...
public class CountrySortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHolder.country_sortName = view.findViewById(R.id.country_catalog);
            viewHolder.country_name = view.findViewById(R.id.country_name);
            viewHolder.country_number = view.findViewById(R.id.country_number);
