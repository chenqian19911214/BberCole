...
public class LiveBoadcastNearbyGridViewAdapter extends BaseAdapter {
    List<NearbyBroadcastBean.DataCollectionBean> items;
    Context context;

    public LiveBoadcastNearbyGridViewAdapter(Context context, List<NearbyBroadcastBean.DataCollectionBean> items) {
