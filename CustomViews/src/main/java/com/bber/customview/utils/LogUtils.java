package com.bber.customview.utils;
...
public class LogUtils {
    ...
    public static String customTagPrefix = "vencent"; // 自定义Tag的前缀，可以是作者名
    private static final boolean isSaveLog = false; // 是否把保存日志到SD卡中
    public static final String ROOT = Environment.getExternalStorageDirectory()
            .getPath() + "/vencent/"; // SD卡中的根目录
    ...
    public static boolean allowD = isPrintLog && true;
    public static boolean allowE = isPrintLog && true;
    public static boolean allowI = isPrintLog && true;
    public static boolean allowV = isPrintLog && true;
    public static boolean allowW = isPrintLog && true;
    public static boolean allowWtf = isPrintLog && true;
